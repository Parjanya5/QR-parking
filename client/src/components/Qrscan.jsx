      ...
      <div className="">
        ...
        <div className="card" style={{ width: "18rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text">Vehicle Number: {data.vehicle}</p>
            <p className="card-text">Vehicle Model: {data.model}</p>
            <p className="card-text">Vehicle Color: {data.color}</p>
            <p className="card-text">Contact: {data.phone}</p>
